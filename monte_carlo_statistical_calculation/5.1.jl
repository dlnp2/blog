...
function demo()
    ...
    data_hist = histogram(data, title = "histogram (raw data)")
    params_hist = histogram(params, title = "histogram (parameters)")
    series_plot = plot(params, title = "chain")
    autocor_plot = plot(ac, st = :bar, title = "autocorrelation")
